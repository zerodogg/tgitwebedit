...
sub footer
{
	my $o = '</div><div id="footer"><br /><br /><small>Generated by TGitWebEdit version '.$VERSION.'<br /><small>Licensed under the <a href="http://www.gnu.org/licenses/agpl.html">GNU AGPL version 3 or (at your option) any later version</a>. <a href="'.$q->url().'?type=source">Get the source.</a>.</small></small></div>';
	if (@warnings)
	{
